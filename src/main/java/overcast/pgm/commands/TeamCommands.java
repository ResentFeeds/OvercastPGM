...
public class TeamCommands {
						...
						for (WoolObjective wool : wools) {
							if (wool != null) {
								String completed = wool.isCompleted()
										? " " + ChatColor.GREEN + wool.getChatacter().getUTF()
										: " " + ChatColor.RED + wool.getChatacter().getUTF();
	...
	public static void aliases(final CommandContext args, CommandSender sender) {
		...
		if (team != null) {
			...
			Bukkit.broadcastMessage(ChatColor.RED + "No team found by " + ChatColor.DARK_RED + team);
		}
	}
